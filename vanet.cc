...
VanetRoutingExperiment::VanetRoutingExperiment ()
  : m_port (9),
    ...
    // 1=802.11p
    m_80211mode (1),
    m_traceFile ("scratch/ns2mobility.tcl"),
    m_logFile ("main-ns2-mob.log"),
...
static ns3::GlobalValue g_traceFile ("VRCtraceFile",
                                     ...
                                     ns3::StringValue ("./scratch/ns2mobility.tcl"),
                                     ns3::MakeStringChecker ());
static ns3::GlobalValue g_logFile ("VRClogFile",
                                   "Log filename",
                                   ns3::StringValue ("main-ns2-mob.log"),
                                   ns3::MakeStringChecker ());
...
VanetRoutingExperiment::Run ()
{
  ...
  Simulator::Stop (Seconds (m_TotalSimTime));
    ...
    AnimationInterface anim ("a3.xml");
  Simulator::Run ();
  Simulator::Destroy ();
}
...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
    ...
    {
      // Realistic vehicular trace in 4.6 km x 3.0 km saida
      // "low density, 30 total vehicles"
      m_traceFile = "scratch/ns2mobility.tcl";
      m_logFile = "main-ns2-mob.log";
      m_mobility = 1;
      m_nNodes = 30;
      m_TotalSimTime = 866.01;
      m_nodeSpeed = 150;
      m_nodePause = 0;
      m_CSVfileName = "low_vanet-routing-compare.csv";
      m_CSVfileName = "low_vanet-routing-compare2.csv";
